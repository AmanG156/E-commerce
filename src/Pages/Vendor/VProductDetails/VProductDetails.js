...
import OrderLogo from "../../../assests/OrderLogo.png";
import IncomeLogo from "../../../assests/IncomeLogo.png";
import ExpenseLogo from "../../../assests/ExpenseLogo.png";
        ...
        <div className="col-lg-9">
          <div className="detail_div">
            <div className="col">
              ...
              <div className="row Product_details_div">
                <div className="col md-4">
                  <div className="card VProduct_Card ">
                    <div className="card-body">
                      <div className="row">
                        <p className=" fw-bold text-secondary Order_Card">
                          New Order
                        </p>
